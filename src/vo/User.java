...
public class User implements Serializable {
	...
	public String toString() {
		return "User [userNo=" + userNo + ", userId=" + userId + ", userPw=" + userPw + ", userName=" + userName
				+ ", userPhoneNo=" + userPhoneNo + ", borrowSuspend=" + borrowSuspend
				+ ", borrowBookList=" + borrowBookList + ", borrowBookCount=" + borrowBookCount
				+ ", borrowBookHistoryCount=" + borrowBookHistoryCount + "]";
	}
