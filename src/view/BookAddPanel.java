...
public class BookAddPanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("BookAdd")) {
			Frame.getBookList().put(tfBookNo.getText(), new Book(tfBookNo.getText(), tfBookTitle.getText(),
					tfAuthor.getText(), tfPublisher.getText(), cbGenre.getSelectedItem().toString()));
