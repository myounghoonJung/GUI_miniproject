...
public class LoginPanel extends JPanel implements ActionListener, MouseListener, FocusListener {
	...
	public LoginPanel(Frame f) {
		...
		txtFldLoginId.registerKeyboardAction(this, "Login", KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), JComponent.WHEN_FOCUSED);
		
		// 패스워드입력칸에서 엔터를 치게되면 로그인
		pwFldLogin.registerKeyboardAction(this, "Login", KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), JComponent.WHEN_FOCUSED);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand() == "Login") {
			...
			// 사용자 로그인
				...
				JOptionPane.showMessageDialog(null, Frame.getLoginUser().getUserName() + "님 환영합니다.", "사용자 로그인", JOptionPane.YES_OPTION);
